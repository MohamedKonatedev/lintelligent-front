          ...
          <div className="relative mx-auto max-w-7xl px-4 pb-14 pt-20 sm:px-6 sm:pb-20 sm:pt-24 lg:px-8 lg:pb-24 lg:pt-28">
            <div className="max-w-4xl">
              ...
              <h1 className="mt-6 max-w-3xl text-[clamp(1.8rem,4.2vw,3.7rem)] font-extrabold leading-[0.96] tracking-tight text-white">
                Mentions
                <span className="block text-white/78">légales</span>
              </h1>
  
              <p className="mt-6 max-w-2xl text-[1rem] leading-7 text-white/78 sm:text-[1.08rem] sm:leading-8">
                Retrouvez ici les informations légales relatives à l’éditeur, à
                l’hébergement et à l’utilisation du site L&apos;Intelligent TV.
              </p>
            </div>
          </div>
        </section>
              ...
              <div className="mt-8 space-y-6">
                ...
                <div className="rounded-[22px] border border-white/10 bg-white/[0.04] p-5">
                  ...
                  <p className="mt-3 text-sm leading-7 text-white/76">
                    L’ensemble des contenus présents sur le site L&apos;Intelligent
                    TV, incluant notamment les textes, images, vidéos, logos,
                    éléments graphiques et documents, est protégé par les lois en
                    vigueur relatives à la propriété intellectuelle. Toute
                    reproduction, représentation, modification ou diffusion,
                    totale ou partielle, sans autorisation préalable, est
                    interdite.
                  </p>
                </div>
                ...
                <div className="rounded-[22px] border border-white/10 bg-white/[0.04] p-5">
                  ...
                  <p className="mt-3 text-sm leading-7 text-white/76">
                    ...
                    fiables et à jour. Toutefois, il ne saurait garantir
                    l’exactitude, l’exhaustivité ou l’actualité permanente des
                ...
                <div className="rounded-[22px] border border-white/10 bg-white/[0.04] p-5">
                  ...
                  <p className="mt-3 text-sm leading-7 text-white/76">
                    Le présent site est soumis au droit applicable en Côte
                    d&apos;Ivoire, sous réserve des dispositions impératives
                    applicables en matière d’hébergement et de services
                    numériques.
                  </p>
                </div>
              </div>
